...
class myNN(nn.Module):
    def __init__(self):
        ...
        self.layer1 = nn.Conv2d(3, 30,  kernel_size= 3, stride=1 , padding=1) # inputs to layer 1
        self.batchNorm1 = nn.BatchNorm2d( 30 )
        self.layer2 = nn.Conv2d(30, 40,  kernel_size= 3, stride=1 , padding=1) # inputs to layer 2
        self.batchNorm2 = nn.BatchNorm2d( 40 )
        self.layer3 = nn.Conv2d(40, 20,  kernel_size= 3, stride=1 , padding=1) # inputs to layer 2
        self.batchNorm3 = nn.BatchNorm2d( 20 )
        self.layer4 = nn.Conv2d(20, 100,  3, 1 , 1) #The output can be modified for loss testing
...
epoch = 50  #TEMPORARY FOR NOW WHILE WE wait for RUNPOD - runpod works
